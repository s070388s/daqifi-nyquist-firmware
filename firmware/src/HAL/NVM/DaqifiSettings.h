...
extern "C" {
    ...
    typedef struct sWifiSettings
    {
         ...
         * 
         * WDRV_SECURITY_OPEN
         * WDRV_SECURITY_WEP_40
         * WDRV_SECURITY_WEP_104
         * WDRV_SECURITY_WPA_AUTO_WITH_KEY
         * WDRV_SECURITY_WPA_AUTO_WITH_PASS_PHRASE
         * WDRV_SECURITY_WPS_PUSH_BUTTON
         * WDRV_SECURITY_WPS_PIN
         */
