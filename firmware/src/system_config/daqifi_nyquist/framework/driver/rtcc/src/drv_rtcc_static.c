...
void DRV_RTCC_Initialize(void)
{
    ...
    PLIB_RTCC_AlarmMaskModeSelect(RTCC_ID_0, RTCC_ALARM_ONCE_A_YEAR); /* Set RTCC alarm mode */
    PLIB_RTCC_ClockSourceSelect(RTCC_ID_0,RTCC_CLOCK_SOURCE_SOSC); /* Set RTCC clock source (LPRC/SOSC) */
