...
#define WF_POWER_PORT_CHANNEL       PORT_CHANNEL_H
#define WF_POWER_BIT_POS            13

#define WF_RESET_PORT_CHANNEL       PORT_CHANNEL_H
#define WF_RESET_BIT_POS            13

#define WDRV_DEFAULT_NETWORK_TYPE WDRV_NETWORK_TYPE_INFRASTRUCTURE // WDRV_NETWORK_TYPE_SOFT_AP
#define WDRV_DEFAULT_CHANNEL 6
#define WDRV_DEFAULT_SSID "WiFi_Test" //DAQiFi"

#define WDRV_DEFAULT_SECURITY_MODE WDRV_SECURITY_WPA_WITH_PASS_PHRASE //WDRV_SECURITY_OPEN
...
#define WDRV_DEFAULT_PSK_PHRASE "WiFi_Test" //"Microchip 802.11 Secret PSK Password" // default WPA-PSK or WPA2-PSK passphrase
