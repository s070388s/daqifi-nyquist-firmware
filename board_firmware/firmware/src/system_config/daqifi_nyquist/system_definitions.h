...
// DM: 3/13/2017: Microchip is fairly sloppy with their warnings.
// To avoid getting spammed during compilation, temporarily disable some of the more common issues
...
// DM: 3/13/2017: Re-enable warnings so problems in our code are identified
