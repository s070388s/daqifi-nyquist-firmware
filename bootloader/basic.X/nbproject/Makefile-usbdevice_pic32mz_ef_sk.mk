...
dist/${CND_CONF}/${IMAGE_TYPE}/basic.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../../../bin/framework/peripheral/PIC32MZ2048EFM144_peripherals.a ../src/system_config/usbdevice_pic32mz_ef_sk/btl_mz.ld ../../firmware/DAQiFi_3_0.X/dist/pic32mz_ef_sk__ioexp__11n__freertos/production/DAQiFi_3_0.X.production.hex
	...
	@"C:/Program Files (x86)/Microchip/MPLABX/v4.20/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files (x86)/Microchip/MPLABX/v4.20/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" dist/${CND_CONF}/${IMAGE_TYPE}/basic.X.${IMAGE_TYPE}.hex ../../firmware/DAQiFi_3_0.X/dist/pic32mz_ef_sk__ioexp__11n__freertos/production/DAQiFi_3_0.X.production.hex -odist/${CND_CONF}/production/basic.X.production.unified.hex
...
.build-subprojects:
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
	cd /D ../../firmware/DAQiFi_3_0.X && ${MAKE}  -f Makefile CONF=pic32mz_ef_sk__ioexp__11n__freertos TYPE_IMAGE=DEBUG_RUN
else
	cd /D ../../firmware/DAQiFi_3_0.X && ${MAKE}  -f Makefile CONF=pic32mz_ef_sk__ioexp__11n__freertos
endif


# Subprojects
.clean-subprojects:
	cd /D ../../firmware/DAQiFi_3_0.X && ${MAKE}  -f Makefile CONF=pic32mz_ef_sk__ioexp__11n__freertos clean
