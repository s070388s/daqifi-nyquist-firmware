...
#define SYS_PORT_B_TRIS         0xbdfe
#define SYS_PORT_B_LAT          0x0
#define SYS_PORT_B_ODC          0x0
#define SYS_PORT_B_CNPU         0x4002
#define SYS_PORT_B_CNPD         0x0
#define SYS_PORT_B_CNEN         0x8
